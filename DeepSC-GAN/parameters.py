...
def para_config():
    ...
    #star-transformer设计
    parser.add_argument('--cycle-num', default=8, type=int, help='内层循环次数')#8
    parser.add_argument('--cycle-layers', default=8, type=int, help='外层循环次数')
    ...
    args = parser.parse_known_args()[0]#原来的形式是parser.parse_args()，jupyter报错
